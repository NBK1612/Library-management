...
<h1>Tìm kiếm mượn trả</h1>
<br>
<form action="" method="GET">
    <label for="search">Tìm kiếm theo mã mượn trả:</label>
...
if (isset($_GET['keyword']) && !empty($_GET['keyword'])) {
    ...
    $sql = "SELECT * FROM orderdetail WHERE mahd LIKE '%$keyword%'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<li>" ."- Mã mượn trả: ". $row['mahd'] . "</li>";
        echo "<li>" ." - Mã sách: ". $row['ma_sp']  . "</li>";
        echo "<li>" ." - Tên sách: ". $row['tensp']  . "</li>";
        echo "<li>" ." - Số lượng mượn: ". $row['soluong']  . "</li>";
        ...
        echo "Không tìm thấy thông tin mượn trả phù hợp.";
    }
    } else {
